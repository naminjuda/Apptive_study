...
////        return new ApiResponse<>(FAIL, ErrorValidationResult.ERROR_STATUS_CODE, ErrorValidationResult.ERROR_MESSAGE,
////                e.getValidation());
////    }
////
//        public static ApiResponse<?> errorResponse(ApptiveStudyException e) {
